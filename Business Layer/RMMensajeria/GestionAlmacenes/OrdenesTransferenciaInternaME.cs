...
public class OrdenesTransferenciaInternaME
{
    ...
    public OrdenesTransferenciaInternaME(Guid ordenTransferenciaID, Guid almacenOrigenID, Guid almacenDestinoID, Guid productoID, decimal cantidadTransferida, DateTime fechaTransferencia, string estadoTransferencia, string usuarioResponsable)
    {
    ...
    public OrdenesTransferenciaInternaME()
    {
    }
}
