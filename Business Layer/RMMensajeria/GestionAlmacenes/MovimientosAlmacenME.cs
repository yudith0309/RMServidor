...
public class MovimientosAlmacenME
{
    ...
    public MovimientosAlmacenME(Guid movimientoID, Guid productoID, Guid ubicacionOrigenID, Guid ubicacionDestinoID, string tipoMovimiento, decimal cantidadMovida, DateTime fechaMovimiento, string documentoRelacionado, string usuarioResponsable)
    {
