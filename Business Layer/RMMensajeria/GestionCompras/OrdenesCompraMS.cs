...
public class OrdenesCompraMS
{
    ...
    public OrdenesCompraMS(Guid ordenCompraID, Guid proveedorID, DateTime fechaOrden, DateTime? fechaEntregaEstimada, decimal total, string estado, DateTime fechaCreacion, DateTime fechaActualizacion)
    {
