...
public class RutasME
{
    ...
    public RutasME(Guid rutaID, Guid ordenEnvioID, string puntoSalida, string puntoDestino, decimal distancia, string tiempoEstimado, DateTime fechaCreacion, DateTime fechaActualizacion)
    {
        RutaID = rutaID;
